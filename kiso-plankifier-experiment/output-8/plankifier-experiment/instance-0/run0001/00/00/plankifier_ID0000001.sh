...
pegasus-kickstart  -n plankifier -N ID0000001 -R condorpool  -s predict_unanimityabs0.6.txt=predict_unanimityabs0.6.txt -L plankifier-wf -T 2026-01-16T03:12:48+00:00 /srv/plankifier/predict.py -modelfullnames /srv/plankifier/trained-models/conv2/keras_model.h5 -weightnames /srv/plankifier/trained-models/conv2/bestweights.hdf5 -testdirs /srv/plankifier/camera-images -thresholds 0.6 -ensMethods unanimity -predname ./predict
job_ec=$?
