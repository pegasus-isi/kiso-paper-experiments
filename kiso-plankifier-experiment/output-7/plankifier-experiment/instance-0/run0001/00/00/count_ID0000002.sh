...
pegasus-kickstart  -n count -N ID0000002 -o count.txt -R condorpool  -s count.txt=count.txt -L plankifier-wf -T 2026-01-16T02:25:48+00:00 ./count predict_unanimityabs0.6.txt count.txt
job_ec=$?
